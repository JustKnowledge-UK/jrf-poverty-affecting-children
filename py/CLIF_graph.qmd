...
This script acquires and processes Children in Low Income Families data to produce a line graph of children in low income families in the UK, Haringey and Northumberland Park over time
...
file_loc = set_file_location()
create_record_cols(ward_df, file_loc, 'https://assets.publishing.service.gov.uk/media/67dc2c58c5528de3aa6711f9/children-in-low-income-families-local-area-statistics-2014-to-2024.ods')

write_with_pk(ward_df, 'cilif_relative_ward_2014_2024', 'raw', pk_col='area_code', engine)
...
fig.savefig('../outputs/UK_Haringey_NP_CLIF.png', dpi=300, bbox_inches='tight')
