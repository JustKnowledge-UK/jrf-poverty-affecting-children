...
sns.lineplot(x=list(range(2014, 2023)), y=uk_pc_low_income[0], lw=5, ax=ax, label='Line A', legend=False, color=jk_colours[2])
sns.lineplot(x=list(range(2014, 2023)), y=haringey_pc_low_income[177], lw=5, ax=ax, label='Line B', legend=False, color=jk_colours[3])
sns.lineplot(x=list(range(2014, 2023)), y=numpark_pc_low_income[4150], lw=5, ax=ax, label='Line C', legend=False, color=jk_colours[4])
