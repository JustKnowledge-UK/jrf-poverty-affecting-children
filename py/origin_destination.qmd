...
for stadium in stadia['Stadium'].unique():
    ...
    residence_counts = stadium_workers.groupby(['stadium','location','place_of_work_indicator_label'])['count'].sum().reset_index()
...
fig.savefig(os.path.join('..','outputs','session3','stadium_employment.png'), dpi=300, bbox_inches='tight')
```
...
london1 = all_results.loc[(all_results['region']=='London') & all_results['place_of_work_indicator_label'].str.contains('Mainly working at or from home')]
...
ax.set_ylabel('')
ax.legend().set_title('')
ax.set_title(london1['place_of_work_indicator_label'].unique()[0])
# fig.suptitle('Where workers in a stadium MSOA live')
...
london2 = all_results.loc[(all_results['region']=='London') & all_results['place_of_work_indicator_label'].str.contains('not working at or from home')]
...
ax.set_ylabel('')
ax.legend().set_title('')
ax.set_title(london2['place_of_work_indicator_label'].unique()[0])
# fig.suptitle('Where workers in a stadium MSOA live')
