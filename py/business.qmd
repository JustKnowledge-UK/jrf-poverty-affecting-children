...
yearly_combined.to_pickle(os.path.join('..','data','yearly_combined.pkl'))
...
n4, n16 and further south (hackney + more), stoke newington etc.
...
yearly_combined.to_pickle(os.path.join('..','data','yearly_combined2.pkl'))
