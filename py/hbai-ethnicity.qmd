...
payload = {
    ...
    "recodes": {
        "str:field:HBAI:V_F_HBAI:TYPE_AGECAT": {
            "map": [
                # ["str:value:HBAI:V_F_HBAI:TYPE_AGECAT:C_HBAI_TYPE:1"] # This was all children (incl. under 19s)
                ["str:value:HBAI:V_F_HBAI:TYPE_AGECAT:C_HBAI_TYPE_AGECAT:1"] # This is under 16s only
                ],
            "total": False
        },
        ...
        "str:field:HBAI:V_F_HBAI:ETHGRPHHPUB": {
            "map": [
                ...
                ["str:value:HBAI:V_F_HBAI:ETHGRPHHPUB:C_HBAI_ETH:2"],
...
df2_wide['Ethnicity'] = df2_wide['Ethnicity'].str.replace('/ ', '/')
...
df2_wide = df2_wide.sort_values(by='In low income - Percentage')
```
...
fig.savefig(os.path.join('..','outputs','hbai_ethnicity.png'), dpi=300)
```
