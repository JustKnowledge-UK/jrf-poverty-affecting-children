---
title: "\\textbf{Understanding Poverty in Place: Where Data Meets Community in Northumberland Park}"

authors:
  - name: Residents of Northumberland Park
  - name: "Eduardo Araujo^1^"
  - name: "Martina Boyce^2^"
  - name: "Reda Chaaban^2^"
  - name: "Darius Corrigall^3^"
  - name: "Susuana Gyampoh Senghor^2^"
  - name: "Lela Kogbara^4^"
  - name: "Jolyon Miles-Wilson^3^"
  - name: "Darren Niamba^2^"
  - name: "Celestin Okoroji^3,6^"
  - name: "Olivia Opara^2^"
  - name: "Jesse Udaigwe^2^"
  - name: "Tamanda Walker^5^"
  - name: "Unique West-Alese^2^"
...
format:
  pdf:
    ...
    #     \end{center}
    #     \vspace{1cm}
mainfont: InclusiveSans-Regular.ttf
mainfontoptions:
  - BoldFont=InclusiveSans-Bold.ttf
sansfont: InclusiveSans-Bold.ttf
toc: true
toc-depth: 2
citeproc: true
...
<!-- preamble now in before-body.tex -->
...
![](./assets/flyer.jpg){width=90% fig-align="center"}
...
![GVA for the 1km area around Tottenham Hotspur Stadium (THS) and revenue and profit of Tottenham Hotspur Football Club (THFC) since 2010.](./outputs/gva_revenue_profit.png){#fig-14 fig-pos='H'}

![The nine MSOAs forming the 1km area around Tottenham Hotspur Stadium used in data analysis. The two most northerly MSOAs are in Enfield; the remaining seven are in Haringey.](./outputs/ths_1km_msoas.png){#fig-15 fig-pos='H'}

![Percentage change in Gross Value Added (GVA) from 2018 for nine MSOAs in the 1km area around Tottenham Hotspur Stadium, other Haringey MSOAs and London as a whole.](./outputs/gva_index_base2018.png){#fig-16 fig-pos='H'}
